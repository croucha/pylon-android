...
public class PylonTesting extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater.from(this).inflate(R.layout.plyon_testing, tabHost.getTabContentView(), true);
        ...
        tabHost.addTab(tabHost.newTabSpec("tab2").setIndicator(getResources().getText(R.string.pylon_tab)).setContent(R.id.view2));
