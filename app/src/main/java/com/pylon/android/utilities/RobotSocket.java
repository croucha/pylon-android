...
public class RobotSocket {
    ...
    public RobotSocket(Activity activity, String uri) {
        ...
        try {
            webSocketConnection.connect(wsUri, new WebSocketConnectionHandler() {
                ...
                public void onTextMessage(String payload) {
                    ...
                    final LinearLayout layout = (LinearLayout) activity.findViewById(R.id.messages);
     ...
     * @return RobotSocket
     */
    public RobotSocket sendTextMessage(String text) {
